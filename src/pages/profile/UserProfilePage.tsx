      ...
      <div className="relative overflow-hidden rounded-3xl bg-linear-to-r from-slate-900 via-sky-950 to-slate-900 border border-slate-800 p-6 md:p-8 text-white shadow-xl">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start gap-6">
          ...
          <div className="relative group shrink-0">
            <div className="w-24 h-24 md:w-28 md:h-28 rounded-3xl bg-slate-800 border-2 border-sky-400/40 shadow-xl overflow-hidden flex items-center justify-center text-3xl font-extrabold text-white">
              {avatarUrl ? (
          ...
          <div className="flex-1 text-center md:text-left space-y-2">
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-2.5">
              ...
              <span className="px-3 py-1 rounded-full text-xs font-bold font-mono bg-sky-500/20 text-sky-300 border border-sky-400/30">
