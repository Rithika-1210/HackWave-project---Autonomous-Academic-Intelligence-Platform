    ...
    if not existing:
        ...
        defaults = [
            AIRecommendation(
                ...
                problem_identified="Dr. Alan Turing is scheduled for 20 weekly periods, exceeding the institutional ceiling of 18 hours.",
                recommended_action="Reassign 2 weekly periods of Computer Networks to Dr. Ada Lovelace.",
                explanation="Dr. Ada Lovelace has an identical specialization in Distributed Systems and currently has 6 available teaching hours with zero scheduling clashes on Tuesday and Thursday mornings.",
                affected_users_resources="Dr. Alan Turing, Dr. Ada Lovelace, CSE-302 Batch A",
                expected_benefits="Brings Dr. Turing's teaching load into 100% compliance while maintaining student continuity and syllabus pace.",
